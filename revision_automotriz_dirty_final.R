...
ventas <- readr::read_csv("C:/Users/geerm/Desktop/5. R/4. Tidyr y stringr/Automotriz_dirty/ventas_dirty.csv")
clientes <- readr::read_csv("C:/Users/geerm/Desktop/5. R/4. Tidyr y stringr/Automotriz_dirty/clientes_dirty.csv")
modelos <- readr::read_csv("C:/Users/geerm/Desktop/5. R/4. Tidyr y stringr/Automotriz_dirty/modelos_dirty.csv")
comisiones <- readr::read_csv("C:/Users/geerm/Desktop/5. R/4. Tidyr y stringr/Automotriz_dirty/comisiones_dirty.csv")

# Limpieza ----------------------------------------------------------------



clientes %>% distinct(ProvinciaResidencia) %>% arrange(ProvinciaResidencia) %>% View()
...
clientes %>% distinct(Nacionalidad) %>% arrange(Nacionalidad) %>% View()
...
clientes %>% distinct(Genero) %>% arrange(Genero) %>% View()
...
ventas %>% distinct(Estado) %>% arrange(Estado) %>% View()
...
clientes %>% distinct(TipoCliente) %>% arrange(TipoCliente) %>% View()
...
ventas %>% 
  left_join(clientes, by = "IdCliente") %>% 
  left_join(modelos, by = "IdModelo") %>% 
  group_by(Marca, Modelo, Estudios) %>% 
